...
import { Check, Zap, ArrowRight, Star, Calendar, CreditCard } from 'lucide-react';
...
const plans = [
  {
    ...
    price: 299,
    period: 'month',
    features: ['1 active job', '30-day visibility', 'Basic profile', 'Email support'],
    cta: 'Current Plan',
    current: true,
  },
  {
    ...
    price: 799,
    period: 'month',
    features: ['5 active jobs', '60-day visibility', 'Enhanced profile', 'Priority support', 'Applicant tracking', 'Analytics dashboard'],
    cta: 'Upgrade',
    current: false,
    popular: true,
  },
  {
    ...
    price: 2499,
    period: 'month',
    features: ['Unlimited jobs', '90-day visibility', 'Premium profile', 'Dedicated manager', 'Advanced analytics', 'Employer branding', 'Sourcing assistance'],
    cta: 'Contact Sales',
    current: false,
  },
];
    ...
    <div>
      <FadeIn>
        <div className="text-center max-w-2xl mx-auto mb-8">
          ...
          <p className="text-text-secondary">Choose the plan that fits your hiring needs</p>
        </div>
      </FadeIn>
        ...
        <Card className="p-6">
          ...
          <div className="flex items-center gap-4 p-4 rounded-xl bg-surface-elevated">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-text-muted">$299/month · Renews Feb 15, 2024</div>
            </div>
